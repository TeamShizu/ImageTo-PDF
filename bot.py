...
This bot created by @ShizuUpdates""",reply_to_message_id = message.message_id ,  reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Updates Channel" ,url="https://t.me/ShizuUpdates") ],
                 [InlineKeyboardButton("Support Group", url="https://t.me/ShizuSupport_Official") ]       ]        ) )
...
async def done(client,message):
 ...
 await client.send_document(message.from_user.id, open(path, "rb"), caption = "Here your pdf !! Follow us @ShizuUpdates")
 os.remove(path)
